            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                if ($status_id < 5) {
                    echo "
                        ...
                        <button class='btn btn-danger btn-sm' onclick=\"confirmUpdate({$row['IDtransaction']}, '8')\">Cancel</button>
                    ";
                    if ($status_id == 2) {
                        echo "
                        <button class='btn btn-primary btn-sm' onclick=\"window.location.href='./pickup/{$row['IDtransaction']}.pdf'\">Download PDF</button>
                        ";
                    }
                    echo "
                        </td>
